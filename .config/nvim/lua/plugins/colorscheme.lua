...
return {
    {
        ...
        opts = {
            ...
            custom_highlights = function(colors)
                return {
                    FloatTitle = { fg = colors.mantle, bg = colors.flamingo, style = { "bold" } },
                    FloatBorder = { fg = colors.mantle, bg = colors.mantle },
                    NormalFloat = { bg = colors.mantle, style = { "bold" } },
                    ...
                    NoiceCmdlinePopup = { fg = colors.text, bg = colors.mantle },
                    NoiceCmdlinePopupTitle = { fg = colors.mantle, bg = colors.teal },
                    ...
                    TelescopePreviewBorder = { fg = colors.maroon, bg = colors.base },
